...
- **Personal website** built using **GitHub Pages and Jekyll**, including a custom photography gallery with thumbnail generation and external file delivery via Google Drive.

- **Kaggle competition — [Hull Tactical: Market Prediction](https://www.kaggle.com/competitions/hull-tactical-market-prediction)**. Ranked **26 / 3,677 teams (top 0.7%)** on the live leaderboard as of March 2026.
